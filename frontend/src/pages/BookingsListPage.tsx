...
import { bookingApi, memberApi } from '../services/api';
    ...
    try {
      for (const id of uniqueIds) {
        try {
          ...
          // ignore individual member load errors
        }
      }
            ...
            <table>
              ...
              <tbody>
                {bookings.map((booking) => {
                  const member = booking.memberId ? members[booking.memberId] : null;
                  return (
                    <tr key={booking.id}>
                      ...
                      <td>
                        {booking.fromWaitlistId ? (
                          <span className="badge" style={{ backgroundColor: '#fefcbf', color: '#744210' }}>
                            候补
                          </span>
                        ) : (
                          <span className="text-muted">-</span>
        ...
        <div className="modal-overlay" onClick={() => setShowCancelModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              <div className="price-row">
                <span className="text-muted">已支付</span>
                <span style={{ color: '#3182ce', fontWeight: 600 }}>
                  ¥{selectedBooking.paidAmount.toFixed(2)}
                </span>
              </div>
              {refundInfo && (
